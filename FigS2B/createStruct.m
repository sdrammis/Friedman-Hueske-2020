...
% 06/10/2019
% createTable.m
function twdb = createStruct(twdb,age,health,learned,engagementFilt,photoFilt,cStats,noBaseFilt,strio)
...
if strcmp(age,'young') == 1
    twdb = ageFilter(twdb,0,12); % REMEMBER TO CHANGE UB BACK TO 8!!!
%     disp({twdb.firstSessionAge});
...
% filter for striosomality
if strcmp(strio,'Strio') || strcmp(strio,'Matrix')
    twdb = strioFilter(twdb,strio);
end
end