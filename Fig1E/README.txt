...
Tables: DATATABLE.mat
Plotted d' and c curves for early (first third of trials) and last 50 trials for learning WT mice 9-12 months old.
Early = first third of trials
Mid = second third of trials
Late = last third of trials
Ellipse is mean and std-error.
