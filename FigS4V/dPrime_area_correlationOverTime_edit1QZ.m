function [R,slope] = dPrime_area_correlationOverTime_edit1QZ(miceIDs,...
    miceTrials,miceFluorTrials,rewardTones,costTones,engagement,percentage,factor)
...
for m = 1:length(miceIDs)
    ...
    bin_size = round(numTrials*percentage); % percentage = 0.05
    start = factor*bin_size; % factor = 5
