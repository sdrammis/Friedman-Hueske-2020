...
trace470 = remove_steps(trace470, 20, 1.5, 8);
trace405 = remove_steps(trace405, 20, 1.5, 8);
...
[spikeTimes470, spikeTraces470] = get_blue_spike_info(trace470, times470, 1.5);
spikeTraces405 = get_purple_trace_at_blue_spike_ts(trace405, times405, spikeTimes470(:,2));
