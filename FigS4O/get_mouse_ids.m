...
if ~isequal(age,'all')
    ...
    ageCutoff1 = 9;
    if isequal(age,'old')
        mice_idx = cell2mat(twdb_lookup(twdb(mice_idx),'index','grade','firstSessionAge',ageCutoff2+1,Inf));
    elseif isequal(age,'young')
        mice_idx = cell2mat(twdb_lookup(twdb(mice_idx),'index','grade','firstSessionAge',0,ageCutoff1));
    elseif isequal(age, 'medium')
         mice_idx = cell2mat(twdb_lookup(twdb(mice_idx),'index','grade','firstSessionAge',ageCutoff1+1,ageCutoff2));
    end
end
